...
python -m cyto_dl.eval experiment=im2im/eval_scale2.yaml paths.data_dir=$1/runtime_data
python -m cyto_dl.eval experiment=im2im/eval_scale3.yaml paths.data_dir=$1/runtime_data
