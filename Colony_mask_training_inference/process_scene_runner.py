...
def main():
    ...
    parser.add_argument('--max-processes', type=int, default=None,
                       help='Maximum number of concurrent processes. Default: number of scenes (no limit)')
    parser.add_argument('--csv-path', type=str, default=DEFAULT_CSV_PATH,
                       help='Path to the CSV file containing movie paths')
    ...
    parser.add_argument('--base-path', type=str, default=DEFAULT_BASE_PATH,
                       help=f'Base path for all data directories (default: {DEFAULT_BASE_PATH})')
